...
#
#  QuakeJS joins all argv into one string then splits on
#  unquoted '+'. Actions like +forward start with '+', which
#  would be treated as a command separator. Wrapping them in
#  quotes ("+forward") prevents this.
#
#  Format:  "+command", "arg1", '"+action"'
...
# 2. Inject CLIENT_COMMANDS into index.html before ioq3.callMain(args)
